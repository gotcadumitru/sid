...
var STACK_BASE = 16108304,
  STACK_MAX = 21351184,
  DYNAMIC_BASE = 21351184,
  DYNAMICTOP_PTR = 16108272;
...
if (Module['buffer']) {
  ...
  assert(
    ...
    'provided buffer should be ' + INITIAL_TOTAL_MEMORY + ' bytes, but it is ' + buffer.byteLength
  );
} else {
  ...
  function instantiateArrayBuffer(receiver) {
    getBinaryPromise()
      .then(function (binary) {
        return WebAssembly.instantiateStreaming(binary, info);
      })
...
var GL = {
  ...
  validateVertexAttribPointer: function (dimension, dataType, stride, offset) {
    ...
    if (dimension == 32993) {
      console.error(
        'WebGL does not support size=GL_BGRA in a call to glVertexAttribPointer! Please use size=4 and type=GL_UNSIGNED_BYTE instead!'
      );
    ...
    if (offset % sizeBytes != 0) {
      console.error(
        'GL spec section 6.4 error: vertex attribute data offset of ' +
          offset +
          ' bytes should have been a multiple of the data type size that was used: GLenum ' +
          dataType +
          ' has size of ' +
          sizeBytes +
          ' bytes!'
    ...
    if (stride % sizeBytes != 0) {
      console.error(
        'GL spec section 6.4 error: vertex attribute data stride of ' +
          stride +
          ' bytes should have been a multiple of the data type size that was used: GLenum ' +
          dataType +
          ' has size of ' +
  ...
  registerContext: function (ctx, webGLContextAttributes) {
    ...
    if (webGLContextAttributes.renderViaOffscreenBackBuffer)
      err(
        'renderViaOffscreenBackBuffer=true specified in WebGL context creation attributes, pass linker flag -s OFFSCREEN_FRAMEBUFFER=1 to enable support!'
      );
    return handle;
  },
...
function _eglCreateContext(display, config, hmm, contextAttribs) {
  ...
  if (glesContextVersion < 2 || glesContextVersion > 3) {
    if (glesContextVersion == 3) {
      ...
      err(
        'When initializing GLES2/WebGL1 via EGL, one must pass EGL_CONTEXT_CLIENT_VERSION = 2 to GL context attributes! GLES version ' +
          glesContextVersion +
          ' is not supported!'
      );
    }
...
function _emscripten_glDrawBuffers(n, bufs) {
  ...
  assert(
    n < __tempFixedLengthArray.length,
    'Invalid count of numBuffers=' + n + ' passed to glDrawBuffers (that many draw buffer points do not exist in GL)'
  );
...
function _emscripten_glGenQueriesEXT(n, ids) {
  for (var i = 0; i < n; i++) {
    ...
    if (!query) {
      GL.recordError(1282);
      err(
        'GL_INVALID_OPERATION in glGenQueriesEXT: GLctx.disjointTimerQueryExt.createQueryEXT returned null - most likely GL context is lost!'
      );
...
function _emscripten_glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetActiveUniformBlockiv(program=' +
        program +
        ', uniformBlockIndex=' +
        uniformBlockIndex +
        ', pname=' +
...
function _emscripten_glGetActiveUniformsiv(program, uniformCount, uniformIndices, pname, params) {
  ...
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetActiveUniformsiv(program=' +
        program +
        ', uniformCount=' +
        uniformCount +
        ', uniformIndices=' +
...
function _emscripten_glGetBufferParameteri64v(target, value, data) {
  if (!data) {
    err(
      'GL_INVALID_VALUE in glGetBufferParameteri64v(target=' +
        target +
        ', value=' +
        value +
        ', data=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glGetBufferParameteriv(target, value, data) {
  if (!data) {
    err(
      'GL_INVALID_VALUE in glGetBufferParameteriv(target=' +
        target +
        ', value=' +
        value +
        ', data=0): Function called with null out pointer!'
...
function emscriptenWebGLGetIndexed(target, index, data, type) {
  if (!data) {
    err(
      'GL_INVALID_VALUE in glGetInteger(64)i_v(target=' + target + ', index=' + index + ', data=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
  ...
  switch (typeof result) {
    ...
    default:
      GL.recordError(1280);
      err(
        'GL_INVALID_ENUM in glGetInteger(64)i_v: Native code calling glGetInteger(64)i_v(' +
          target +
          ') and it returns ' +
          result +
          ' of type ' +
...
function _emscripten_glGetProgramBinary(program, bufSize, length, binaryFormat, binary) {
  GL.recordError(1282);
  err(
    'GL_INVALID_OPERATION in glGetProgramBinary: WebGL does not support binary shader formats! Calls to glGetProgramBinary always fail. See https://www.khronos.org/registry/webgl/specs/latest/2.0/#5.4'
  );
}
...
function _emscripten_glGetProgramiv(program, pname, p) {
  ...
  if (program >= GL.counter) {
    err(
      'GL_INVALID_VALUE in glGetProgramiv(program=' +
        program +
        ', pname=' +
        pname +
        ', p=0x' +
        p.toString(16) +
        '): The specified program object name was not generated by GL!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glGetQueryObjecti64vEXT(id, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetQueryObject(u)i64vEXT(id=' + id + ', pname=' + pname + ', params=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glGetQueryObjectivEXT(id, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetQueryObject(u)ivEXT(id=' + id + ', pname=' + pname + ', params=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glGetQueryivEXT(target, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetQueryivEXT(target=' + target + ', pname=' + pname + ', params=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glGetRenderbufferParameteriv(target, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetRenderbufferParameteriv(target=' +
        target +
        ', pname=' +
        pname +
        ', params=0): Function called with null out pointer!'
...
function _emscripten_glGetSamplerParameterfv(sampler, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetSamplerParameterfv(sampler=' +
        sampler +
        ', pname=' +
        pname +
        ', params=0): Function called with null out pointer!'
...
function _emscripten_glGetSamplerParameteriv(sampler, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetSamplerParameteriv(sampler=' +
        sampler +
        ', pname=' +
        pname +
        ', params=0): Function called with null out pointer!'
...
function _emscripten_glGetSynciv(sync, pname, bufSize, length, values) {
  if (bufSize < 0) {
    err(
      'GL_INVALID_VALUE in glGetSynciv(sync=' +
        sync +
        ', pname=' +
        pname +
        ', bufSize=' +
        ...
        ', values=' +
        values +
        '): Function called with bufSize < 0!'
    );
    GL.recordError(1281);
    return;
  }
  if (!values) {
    err(
      'GL_INVALID_VALUE in glGetSynciv(sync=' +
        ...
        ', length=' +
        length +
        ', values=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glGetTexParameterfv(target, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetTexParameterfv(target=' +
        target +
        ', pname=' +
        pname +
        ', params=0): Function called with null out pointer!'
...
function _emscripten_glGetTexParameteriv(target, pname, params) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetTexParameteriv(target=' +
        target +
        ', pname=' +
        pname +
        ', params=0): Function called with null out pointer!'
...
function _emscripten_glGetUniformIndices(program, uniformCount, uniformNames, uniformIndices) {
  ...
  if (!uniformIndices) {
    err(
      'GL_INVALID_VALUE in glGetUniformIndices(program=' +
        program +
        ', uniformCount=' +
        uniformCount +
        ', uniformNames=' +
        uniformNames +
        ', uniformIndices=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function emscriptenWebGLGetUniform(program, location, params, type) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetUniform*v(program=' +
        program +
        ', location=' +
        location +
        ', params=0): Function called with null out pointer!'
...
function emscriptenWebGLGetVertexAttrib(index, pname, params, type) {
  if (!params) {
    err(
      'GL_INVALID_VALUE in glGetVertexAttrib*v(index=' + index + ', pname=' + pname + ', params=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glGetVertexAttribPointerv(index, pname, pointer) {
  if (!pointer) {
    err(
      'GL_INVALID_VALUE in glGetVertexAttribPointerv(index=' +
        index +
        ', pname=' +
        pname +
        ', pointer=0): Function called with null out pointer!'
    );
    GL.recordError(1281);
    return;
  }
...
function _emscripten_glInvalidateFramebuffer(target, numAttachments, attachments) {
  assert(
    numAttachments < __tempFixedLengthArray.length,
    'Invalid count of numAttachments=' +
      numAttachments +
      ' passed to glInvalidateFramebuffer (that many attachment points do not exist in GL)'
  );
...
function _emscripten_glInvalidateSubFramebuffer(target, numAttachments, attachments, x, y, width, height) {
  assert(
    ...
    'Invalid count of numAttachments=' +
      numAttachments +
      ' passed to glInvalidateSubFramebuffer (that many attachment points do not exist in GL)'
  );
  var list = __tempFixedLengthArray[numAttachments];
  for (var i = 0; i < numAttachments; i++) {
    list[i] = HEAP32[(attachments + i * 4) >> 2];
...
function _emscripten_glProgramBinary(program, binaryFormat, binary, length) {
  GL.recordError(1280);
  err(
    'GL_INVALID_ENUM in glProgramBinary: WebGL does not support binary shader formats! Calls to glProgramBinary always fail. See https://www.khronos.org/registry/webgl/specs/latest/2.0/#5.4'
  );
}
...
function _emscripten_glProgramParameteri(program, pname, value) {
  GL.recordError(1280);
  err(
    'GL_INVALID_ENUM in glProgramParameteri: WebGL does not support binary shader formats! Calls to glProgramParameteri always fail. See https://www.khronos.org/registry/webgl/specs/latest/2.0/#5.4'
  );
}
...
function emscriptenWebGLGetTexPixelData(type, format, width, height, pixels, internalFormat) {
  ...
  if (!sizePerPixel) {
    GL.recordError(1280);
    if (!__colorChannelsInGlTextureFormat[format])
...
function _emscripten_webgl_do_create_context(target, attributes) {
  ...
  if (contextAttributes.explicitSwapControl) {
    console.error(
      'emscripten_webgl_create_context failed: explicitSwapControl is not supported, please rebuild with -s OFFSCREENCANVAS_SUPPORT=1 to enable targeting the experimental OffscreenCanvas specification, or rebuild with -s OFFSCREEN_FRAMEBUFFER=1 to emulate explicitSwapControl in the absence of OffscreenCanvas support!'
    );
    return 0;
  }
...
function nullFunc_dif(x) {
  err(
    "Invalid function pointer called with signature 'dif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_dii(x) {
  err(
    "Invalid function pointer called with signature 'dii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_diid(x) {
  err(
    "Invalid function pointer called with signature 'diid'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_f(x) {
  err(
    "Invalid function pointer called with signature 'f'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiffi(x) {
  err(
    "Invalid function pointer called with signature 'fiffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fifi(x) {
  err(
    "Invalid function pointer called with signature 'fifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fifii(x) {
  err(
    "Invalid function pointer called with signature 'fifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fifiii(x) {
  err(
    "Invalid function pointer called with signature 'fifiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiifi(x) {
  err(
    "Invalid function pointer called with signature 'fiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiifiii(x) {
  err(
    "Invalid function pointer called with signature 'fiifiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiif(x) {
  err(
    "Invalid function pointer called with signature 'fiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiii(x) {
  err(
    "Invalid function pointer called with signature 'fiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiiiiif(x) {
  err(
    "Invalid function pointer called with signature 'fiiiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiiiiifi(x) {
  err(
    "Invalid function pointer called with signature 'fiiiiiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiiiiifiifif(x) {
  err(
    "Invalid function pointer called with signature 'fiiiiiifiifif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiiiiifiiiif(x) {
  err(
    "Invalid function pointer called with signature 'fiiiiiifiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'fiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'fiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fiiijiijiijii(x) {
  err(
    "Invalid function pointer called with signature 'fiiijiijiijii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_fij(x) {
  err(
    "Invalid function pointer called with signature 'fij'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_if(x) {
  err(
    "Invalid function pointer called with signature 'if'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iidf(x) {
  err(
    "Invalid function pointer called with signature 'iidf'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iidfi(x) {
  err(
    "Invalid function pointer called with signature 'iidfi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iidii(x) {
  err(
    "Invalid function pointer called with signature 'iidii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iifffffii(x) {
  err(
    "Invalid function pointer called with signature 'iifffffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiffif(x) {
  err(
    "Invalid function pointer called with signature 'iiffif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiffiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'iiffiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iififi(x) {
  err(
    "Invalid function pointer called with signature 'iififi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iifiiif(x) {
  err(
    "Invalid function pointer called with signature 'iifiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iifiiifiiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'iifiiifiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iifiiii(x) {
  err(
    "Invalid function pointer called with signature 'iifiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iifiiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'iifiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iifiiiiij(x) {
  err(
    "Invalid function pointer called with signature 'iifiiiiij'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiddii(x) {
  err(
    "Invalid function pointer called with signature 'iiiddii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiidi(x) {
  err(
    "Invalid function pointer called with signature 'iiidi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiff(x) {
  err(
    "Invalid function pointer called with signature 'iiiff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiffffiifii(x) {
  err(
    "Invalid function pointer called with signature 'iiiffffiifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiffi(x) {
  err(
    "Invalid function pointer called with signature 'iiiffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiffii(x) {
  err(
    "Invalid function pointer called with signature 'iiiffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiifiifi(x) {
  err(
    "Invalid function pointer called with signature 'iiifiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiifiiiif(x) {
  err(
    "Invalid function pointer called with signature 'iiifiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiddii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiddii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiidi(x) {
  err(
    "Invalid function pointer called with signature 'iiiidi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiidii(x) {
  err(
    "Invalid function pointer called with signature 'iiiidii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiffffi(x) {
  err(
    "Invalid function pointer called with signature 'iiiiffffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiffi(x) {
  err(
    "Invalid function pointer called with signature 'iiiiffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiffii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiffiii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiffiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiffiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiffiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiifiiii(x) {
  err(
    "Invalid function pointer called with signature 'iiiifiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiifiiiii(x) {
  err(
    "Invalid function pointer called with signature 'iiiifiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiif(x) {
  err(
    "Invalid function pointer called with signature 'iiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiffii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiifi(x) {
  err(
    "Invalid function pointer called with signature 'iiiiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiifii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiifiii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiifiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiifiiiif(x) {
  err(
    "Invalid function pointer called with signature 'iiiiifiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiifiiiiif(x) {
  err(
    "Invalid function pointer called with signature 'iiiiifiiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiidii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiidii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiif(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiiffii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiiffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiifi(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiifiif(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiifiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiifiii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiifiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiiifi(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiiifii(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiiifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiiifiif(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiiifiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiiiif(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiiiiiiiji(x) {
  err(
    "Invalid function pointer called with signature 'iiiiiiiiiji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiiij(x) {
  err(
    "Invalid function pointer called with signature 'iiiij'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iiijj(x) {
  err(
    "Invalid function pointer called with signature 'iiijj'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iijiii(x) {
  err(
    "Invalid function pointer called with signature 'iijiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iijji(x) {
  err(
    "Invalid function pointer called with signature 'iijji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_iijjiii(x) {
  err(
    "Invalid function pointer called with signature 'iijjiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_jiiii(x) {
  err(
    "Invalid function pointer called with signature 'jiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_jiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'jiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_jiiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'jiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vidii(x) {
  err(
    "Invalid function pointer called with signature 'vidii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vidiiii(x) {
  err(
    "Invalid function pointer called with signature 'vidiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vidiiiii(x) {
  err(
    "Invalid function pointer called with signature 'vidiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffffff(x) {
  err(
    "Invalid function pointer called with signature 'viffffff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffffffffffffiiii(x) {
  err(
    "Invalid function pointer called with signature 'viffffffffffffiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffffi(x) {
  err(
    "Invalid function pointer called with signature 'viffffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifffiii(x) {
  err(
    "Invalid function pointer called with signature 'vifffiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffi(x) {
  err(
    "Invalid function pointer called with signature 'viffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffif(x) {
  err(
    "Invalid function pointer called with signature 'viffif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffiff(x) {
  err(
    "Invalid function pointer called with signature 'viffiff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffii(x) {
  err(
    "Invalid function pointer called with signature 'viffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffiifiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viffiifiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viffiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viffiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifi(x) {
  err(
    "Invalid function pointer called with signature 'vifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vififfi(x) {
  err(
    "Invalid function pointer called with signature 'vififfi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifii(x) {
  err(
    "Invalid function pointer called with signature 'vifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiifi(x) {
  err(
    "Invalid function pointer called with signature 'vifiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiifiifiiiii(x) {
  err(
    "Invalid function pointer called with signature 'vifiifiifiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiii(x) {
  err(
    "Invalid function pointer called with signature 'vifiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiiifiiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'vifiiifiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiiii(x) {
  err(
    "Invalid function pointer called with signature 'vifiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'vifiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'vifiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vifiiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'vifiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viid(x) {
  err(
    "Invalid function pointer called with signature 'viid'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viidddd(x) {
  err(
    "Invalid function pointer called with signature 'viidddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viidf(x) {
  err(
    "Invalid function pointer called with signature 'viidf'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiff(x) {
  err(
    "Invalid function pointer called with signature 'viiff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifff(x) {
  err(
    "Invalid function pointer called with signature 'viifff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiffffffffiiii(x) {
  err(
    "Invalid function pointer called with signature 'viiffffffffiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiffffffii(x) {
  err(
    "Invalid function pointer called with signature 'viiffffffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiffffiiii(x) {
  err(
    "Invalid function pointer called with signature 'viiffffiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifffi(x) {
  err(
    "Invalid function pointer called with signature 'viifffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiffifi(x) {
  err(
    "Invalid function pointer called with signature 'viiffifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiffii(x) {
  err(
    "Invalid function pointer called with signature 'viiffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiffiiiffffi(x) {
  err(
    "Invalid function pointer called with signature 'viiffiiiffffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viififi(x) {
  err(
    "Invalid function pointer called with signature 'viififi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifii(x) {
  err(
    "Invalid function pointer called with signature 'viifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifiiff(x) {
  err(
    "Invalid function pointer called with signature 'viifiiff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifiifi(x) {
  err(
    "Invalid function pointer called with signature 'viifiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifiii(x) {
  err(
    "Invalid function pointer called with signature 'viifiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifiiii(x) {
  err(
    "Invalid function pointer called with signature 'viifiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viifiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viifiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viifiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiidddd(x) {
  err(
    "Invalid function pointer called with signature 'viiidddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiidi(x) {
  err(
    "Invalid function pointer called with signature 'viiidi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiff(x) {
  err(
    "Invalid function pointer called with signature 'viiiff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiifi(x) {
  err(
    "Invalid function pointer called with signature 'viiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiifif(x) {
  err(
    "Invalid function pointer called with signature 'viiifif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiifii(x) {
  err(
    "Invalid function pointer called with signature 'viiifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiifiif(x) {
  err(
    "Invalid function pointer called with signature 'viiifiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiifiiffii(x) {
  err(
    "Invalid function pointer called with signature 'viiifiiffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiifiii(x) {
  err(
    "Invalid function pointer called with signature 'viiifiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiifiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viiifiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiid(x) {
  err(
    "Invalid function pointer called with signature 'viiiid'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiffi(x) {
  err(
    "Invalid function pointer called with signature 'viiiiffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiifi(x) {
  err(
    "Invalid function pointer called with signature 'viiiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiifiif(x) {
  err(
    "Invalid function pointer called with signature 'viiiifiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiifiiiiif(x) {
  err(
    "Invalid function pointer called with signature 'viiiifiiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiif(x) {
  err(
    "Invalid function pointer called with signature 'viiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiiff(x) {
  err(
    "Invalid function pointer called with signature 'viiiiiff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiiffi(x) {
  err(
    "Invalid function pointer called with signature 'viiiiiffi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiifii(x) {
  err(
    "Invalid function pointer called with signature 'viiiiifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiifiiiif(x) {
  err(
    "Invalid function pointer called with signature 'viiiiifiiiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiiid(x) {
  err(
    "Invalid function pointer called with signature 'viiiiiid'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiiiiiiiifii(x) {
  err(
    "Invalid function pointer called with signature 'viiiiiiiiiiifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiiiiiiiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viiiiiiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiij(x) {
  err(
    "Invalid function pointer called with signature 'viiiij'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiij(x) {
  err(
    "Invalid function pointer called with signature 'viiij'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiijji(x) {
  err(
    "Invalid function pointer called with signature 'viiijji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiji(x) {
  err(
    "Invalid function pointer called with signature 'viiji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viijijj(x) {
  err(
    "Invalid function pointer called with signature 'viijijj'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viijj(x) {
  err(
    "Invalid function pointer called with signature 'viijj'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viijjjii(x) {
  err(
    "Invalid function pointer called with signature 'viijjjii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viji(x) {
  err(
    "Invalid function pointer called with signature 'viji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vijjjii(x) {
  err(
    "Invalid function pointer called with signature 'vijjjii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_vjfi(x) {
  err(
    "Invalid function pointer called with signature 'vjfi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)"
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
